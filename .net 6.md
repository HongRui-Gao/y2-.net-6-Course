...
JWT，即JSON Web Token，它是一种基于JSON的、用于在网络上生命某种主张的令牌（Token）。
    ...
    public static string IssueJwt(TokenModelJwt tokenModel)
    {
        ...
        var claims = new List<Claim>
        {
            ...
            */
            ...
            //这个就是国企时间，目前是过期1000秒，可以自定义，注意JWT有自己的缓冲过期时间
        ...
        var key = new SymmetricSecurityKey对安全性的要求(Encoding.UTF8.GetBytes(secret));
